...
RUN wget https://nsolid-download.nodesource.com/download/nsolid-node/release/v1.2.2/nsolid-v1.2.2-linux-x64.tar.xz \
 && wget https://nsolid-download.nodesource.com/download/nsolid-node/release/v1.2.2/SHASUMS256.txt.asc \
