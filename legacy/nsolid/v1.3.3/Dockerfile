...
RUN wget https://nsolid-download.nodesource.com/download/nsolid-node/release/v1.3.3/nsolid-v1.3.3-linux-x64.tar.xz \
 && wget https://nsolid-download.nodesource.com/download/nsolid-node/release/v1.3.3/SHASUMS256.txt.asc \
