...
RUN wget https://nsolid-download.nodesource.com/download/nsolid-node/release/v1.4.0/nsolid-v1.4.0-linux-x64.tar.xz \
 && wget https://nsolid-download.nodesource.com/download/nsolid-node/release/v1.4.0/SHASUMS256.txt.asc \
